...
# Floor Plan Analysis Hub: _UNet++ Improved_

A high-performance variant of UNet++ upgraded with an **EfficientNet-B4 encoder**. By leveraging a deeper and wider backbone, this model offers significantly higher capacity for feature extraction, delivering superior precision on fine architectural elements and complex boundaries at the cost of increased VRAM usage.
